...
public class stopwatchreal {
    ...
    private static long current_lap; //For nåvørende intervallet

    private static long minutes; //Lagrer minutter
    private static long seconds; //Lagrer sekunder
    private static long milliseconds; //Lagrer millis

    private boolean run; //Boolsk variabel som er true når stoppeklokken teller


    public stopwatchreal() { //Gir verdier til variablene så de kan brukes
        time_start = 0;
        time_stop = 0;
